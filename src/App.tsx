...
function App() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-3xl items-center px-4 py-10">
      <Card className="w-full border-orange-200/80 bg-white/75 shadow-xl backdrop-blur-sm">
        ...
        <CardContent className="space-y-2">
          {visibleTodos.length === 0 ? (
            <div className="rounded-lg border border-dashed border-orange-200 px-4 py-8 text-center text-sm text-muted-foreground">
            ...
            visibleTodos.map((todo) => (
              <div
                key={todo.id}
                className="flex items-center gap-3 rounded-lg border border-orange-100 bg-white px-3 py-2"
              >
                <Checkbox
                  checked={todo.done}
